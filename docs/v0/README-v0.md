> **SUPERSEDED — ARCHIVED v0.**
>
> This is the PSYKI v0 sketch: a two-agent neuromorphic design (Psy/Ki) that no
> longer exists. It is kept as a historical record of where the ideas came from.
>
> **Never read this as architecture.** Canon is `docs/PSYKI_CORE.md`.
> Per AGENTS.md section 1, the newest committed statement wins, and this is not it.
